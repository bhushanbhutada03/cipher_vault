  ...
  ({ className, type, hasError, ...props }, ref) => {
    return (
      <input
        ...
        ref={ref}
        className={cn(
          "flex h-11 w-full rounded-md border bg-surface px-3.5 py-2 text-sm text-foreground placeholder:text-faint-foreground transition-[border-color,box-shadow,background-color] duration-200 ease-out",
